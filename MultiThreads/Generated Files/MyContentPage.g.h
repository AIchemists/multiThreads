...
namespace winrt::MultiThreads::implementation
{
    ...
    struct __declspec(empty_bases) MyContentPage_base : implements<D, MultiThreads::MyContentPage, composing, Windows::UI::Xaml::Controls::IPageOverrides, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = MyContentPage_base;
        using class_type = MultiThreads::MyContentPage;
        using implements_type = typename MyContentPage_base::implements_type;
        using implements_type::implements_type;
        using composable_base = Windows::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"MultiThreads.MyContentPage";
        }
        MyContentPage_base()
        {
...
namespace winrt::MultiThreads::factory_implementation
{
    ...
    struct __declspec(empty_bases) MyContentPageT : implements<D, Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = MultiThreads::MyContentPage;
...
#if defined(WINRT_FORCE_INCLUDE_MYCONTENTPAGE_XAML_G_H) || __has_include("MyContentPage.xaml.g.h")
#include "MyContentPage.xaml.g.h"
#else

namespace winrt::MultiThreads::implementation
{
    template <typename D, typename... I>
    using MyContentPageT = MyContentPage_base<D, I...>;
}
